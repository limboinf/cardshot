...
- 中文字号下限：小红书 1080 卡按 style-library.md「手机优先字号尺」（正文 ≥31px、条目名 42px、封面 h1 130–150px）；其他横图/封面卡正文 ≥26px
...
|---|---|---|---|---|
| 小红书 | 1080×1440（**出图强制 2x：2160×2880**） | 内容驱动选风格：Editorial、Zen、Swiss（含轻瑞士）等 | 封面低；内容页 ≤4–5 条；结尾页 1 句结论 | 封面钩子+语义承接 → 每页一个主结构 → 总结/互动 |
...
| 核心页 | 快速扫描并理解一个结构 | 中：3–4 个条目 | 一个主结构、一个辅助结构、一句结论 | 两个等权主结构、超过 5 个条目 |
| 高密度页 | 承载可收藏的短清单或框架 | 中高：最多 5 个短条目 | 统一行骨架、清晰分区、来源/证据 | 长段落、过小字号、装饰抢正文 |
...
- 主标题 130–150px；三行内放不下时可降到 128px。字重按风格字体体系（Editorial/Zen/Swiss 越大越轻 300-500，其余 700-900）。
...
- 常规每条使用“编号/名称/一句话机制/产物或证据 tag”，正文 31–32px，行距至少 1.5，每页最多 5 条。
...
- 条目区撑满中段，无 >120px 空段；结论紧跟条目，不吸底。

## 小红书结尾页检查

- 一句结论 + 一个 CTA，不引入新事实；主陈述 60–72px ≤4 行；中段 flex 居中无死区；与封面共享眉头/序号/字体/强调色。
